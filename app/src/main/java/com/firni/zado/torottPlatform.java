...
public class torottPlatform extends Platform {

    public torottPlatform(int screenWidth, int screenHeight, int x, int y, int score, Context context){
        ...
        if (!setBitmap(context, R.drawable.torottalapplatform)) Log.e(TAG, "Nem elérhető Platform.bitmap.");
    }
}
